...
![Build Status](https://github.com/taktikorg/hic-perspiciatis-fugit/actions/workflows/ci.yml/badge.svg)
[![Coverage Status](https://coveralls.io/repos/omichelsen/@taktikorg/hic-perspiciatis-fugit/badge.svg?branch=master&service=github)](https://coveralls.io/github/omichelsen/@taktikorg/hic-perspiciatis-fugit?branch=master)
[![npm bundle size (minified + gzip)](https://img.shields.io/bundlephobia/minzip/@taktikorg/hic-perspiciatis-fugit.svg)](https://bundlephobia.com/result?p=@taktikorg/hic-perspiciatis-fugit)
...
```bash
$ npm install @taktikorg/hic-perspiciatis-fugit
```

__Note__: Starting from v5 the main export is now _named_ like so: `import { compareVersions } from '@taktikorg/hic-perspiciatis-fugit'`.
...
```js
import { compareVersions } from '@taktikorg/hic-perspiciatis-fugit';
...
```js
import { compare } from '@taktikorg/hic-perspiciatis-fugit';
...
```js
import { satisfies } from '@taktikorg/hic-perspiciatis-fugit';
...
```js
import { validate } from '@taktikorg/hic-perspiciatis-fugit';
...
```js
import { validateStrict } from '@taktikorg/hic-perspiciatis-fugit';
...
```html
<script src=https://unpkg.com/@taktikorg/hic-perspiciatis-fugit/lib/umd/index.js></script>
<script>
